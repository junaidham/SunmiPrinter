 ...
 * The interfaces for label printing and black mark printing are used in the same way, but you need to pay attention to the different drawing areas for the size of labels or black marks
 */
