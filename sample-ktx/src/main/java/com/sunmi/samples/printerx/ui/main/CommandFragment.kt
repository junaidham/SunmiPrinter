 ...
 * For developers who understand print commands and have already designed print commands, send commands to print
 * There are two sending methods:
 * 1. Send through the SDK interface provided by the SDK
 * 2. Only for SUNMI built-in printers, it can also be sent through the built-in virtual Bluetooth in the connecting device
 */
