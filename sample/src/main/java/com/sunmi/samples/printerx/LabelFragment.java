...
public class LabelFragment extends Fragment {
    ...
    private void printLabel1(int count) {
        try {
            ...
            api.renderText("Brand：SUNMI", TextStyle.getStyle().setTextSize(32).enableBold(true).setPosX(10).setPosY(10));
            api.renderText("SUNMI is an IoT technology company with \"altruism\" as its core value", TextStyle.getStyle().setTextSize(20).setPosX(60)
    ...
    /**
     * Print a product information label
     */
    private void  printLabel2(int count) {
        try {
            ...
            api.renderText("Coca Cola(2L)", TextStyle.getStyle().setTextSize(30).enableBold(true)
            ...
            api.renderText("bottle", TextStyle.getStyle().setTextSize(24)
